...
/**
 * Receives IN_VEHICLE enter/exit transitions from ActivityRecognitionClient and relays them to
 * [DrivingTrackingService] to start/stop GPS location updates. Registered as a manifest receiver
 * (not dynamic) so transitions are still delivered reliably even if the app process was killed.
 */
