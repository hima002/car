...
data class ThemeStyle(
    ...
    val buttonShape: Shape = RoundedCornerShape(if (AppTheme.CYBER_NEON.cardCornerRadius > 20.dp) 50 else 8.dp),
    val chipShape: Shape = RoundedCornerShape(if (AppTheme.CYBER_NEON.cardCornerRadius > 20.dp) 50 else 8.dp),
